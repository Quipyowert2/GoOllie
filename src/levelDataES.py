...
level05=  [section1,'level003',0,0,1,"La historia del gusano",messages.BasicMouseInstructions1,levelMusic3,0,0,1]
level10 =  [section1,'level005',0,0,2,"Junta monedas",messages.coinInstructions1,levelMusic3,0,messages.coinInstructions2,2]
level20 =  [section1,'level010',0,1,3,"Desplaz\xE1ndose",messages.ScrollInstructions1,levelMusic3,0,messages.ScrollInstructions2,3]
level40 =  [section1,'level020',4,0,4,"Ollie se sacude",messages.MoversInstructions,levelMusic2,0,0,6]
level60 =  [section1,'level030',4,0,5,"\xA1Ensalada de frutas!",messages.BlocksInstructions1,levelMusic2,0,messages.BlocksInstructions2,5]
level30 =  [section1,'level015',0,1,6,"Reptantes repulsivos",messages.EnemyInstructions1,levelMusic2,0,messages.EnemyInstructions2,4]
level70 =  [section1,'level035',4,0,7,"Aventura",messages.FirstGemInstructions,levelMusic1,0,messages.SnakePowerInstructions,7]
level80 =  [section1,'level040',4,0,8,"Complic\xE1ndose",0,levelMusic1,0,0,8]
level90 =  [section1,'level045',5,0,9,"Mucho trabajo",0,levelMusic2,0,0,9]
level100 = [section1,'level050',5,0,10,"Tarz\xE1n",0,levelMusic2,0,0,10]
level110 = [section1,'level055',5,0,11,"Est\xE1tico",0,levelMusic1,0,0,11]
level120 = [section1,'level060',5,0,12,"Acelerado",0,levelMusic1,0,0,12]
level130 = [section1,'level065',5,0,13,"Colgado",messages.SecondGemInstructions1,levelMusic1,0,0,13]
level140 = [section1,'level070',5,0,14,"Pinchazo en la cola",0,levelMusic3,0,0,14]
level150 = [section1,'level075',5,0,15,"Casi afuera",messages.FirstKeyInstructions1,levelMusic1,0,0,15]

level160 = [section2,'level105',5,3,16,"Navaja",messages.SecondKeyInstructions1,levelMusic4,0,messages.SecondKeyInstructions2,29]
level170 = [section2,'level110',5,3,17,"Baticueva",0,levelMusic2,2,0,30]
level180 = [section2,'level115',5,0,18,"Duplicidad",0,levelMusic4,0,0,31]
level190 = [section2,'level120',5,3,19,"Tormento",messages.ThirdGemInstructionsA,levelMusic1,0,messages.ThirdGemInstructionsB,26]
level200 = [section2,'level125',5,3,20,"Deslizamiento veloz",0,levelMusic1,2,0,27]
level210 = [section2,'level130',5,0,21,"Complejo",0,levelMusic3,2,0,28]
level220 = [section2,'level135',5,0,22,"Carisma",0,levelMusic2,0,0,23]
level230 = [section2,'level140',5,0,23,"Rotaci\xF3n",0,levelMusic3,0,0,24]
level240 = [section2,'level145',5,0,24,"Pureza",0,levelMusic4,0,0,25]
level250 = [section2,'level150',6,0,25,"Encantado",0,levelMusic3,0,0,22]
level260 = [section2,'level155',6,0,26,"Aracn0fobia",0,levelMusic2,0,0,21]
level270 = [section2,'level160',6,0,27,"Necesitas ruedas",0,levelMusic2,0,0,20]
level280 = [section2,'level165',6,0,28,"Plan secreto",messages.HiddenInstructions,levelMusic4,0,0,17]
level290 = [section2,'level170',6,0,29,"M\xE1s grande es mejor ",messages.SecondGemInstructions2,levelMusic4,0,0,18]
level300 = [section2,'level175',6,0,30,"Piedras preciosas",messages.CaveGems,levelMusic2,0,messages.CaveGems2,19]

level310 = [section3,'level205',5,0,31,"Agradable paseo",0,levelMusic2,0,0,33]
level320 = [section3,'level210',6,0,32,"Rebotando",messages.TrampInstructions,levelMusic2,0,0,34]
level330 = [section3,'level215',6,0,33,"Poder floral",0,levelMusic1,0,0,35]
level340 = [section3,'level220',6,0,34,"Invertido",0,levelMusic2,0,0,40]
level350 = [section3,'level225',6,0,35,"S\xEDmbolos",0,levelMusic4,0,0,39]
level360 = [section3,'level230',6,0,36,"Punzada",0,levelMusic2,0,0,36]
level370 = [section3,'level235',6,0,37,"A prisa",0,levelMusic1,0,0,41]
level380 = [section3,'level240',6,0,38,"Misterioso",0,levelMusic3,0,0,38]
level390 = [section3,'level245',6,0,39,"Juego de pelota",0,levelMusic4,0,0,37]
level400 = [section3,'level250',6,0,40,"Vida en el parque",0,levelMusic1,0,0,42]
level410 = [section3,'level255',6,0,41,"Pit\xF3n saltarina",0,levelMusic2,0,0,43]
level420 = [section3,'level260',6,0,42,"\xA1Tic tac!",0,levelMusic3,3,0,44]
level430 = [section3,'level265',6,0,43,"De rebote",0,levelMusic3,0,0,45]
level440 = [section3,'level270',6,0,44,"Enlaces",0,levelMusic2,3,0,46]
level450 = [section3,'level275',6,0,45,"Castidad",0,levelMusic4,0,0,47]

level460 = [section4,'level305',6,0,46,"Derecho a casa",0,levelMusic3,0,0,61]
level470 = [section4,'level310',6,0,47,"Cruzada en la cueva",0,levelMusic4,0,0,62]
level480 = [section4A,'level315',6,0,48,"Final en la jungla",0,levelMusic1,0,0,63]
level490 = [section4,'level320',6,0,49,"Fren\xE9tico",0,levelMusic1,0,0,58]
level500 = [section4,'level325',6,0,50,"Fugaz",0,levelMusic2,0,0,59]
level510 = [section4,'level330',6,0,51,"Reuni\xF3n",0,levelMusic4,0,0,60]
level520 = [section4,'level335',6,0,52,"S\xEDncopa",0,levelMusic4,4,0,55]
level530 = [section4,'level340',6,0,53,"Up, up & away",0,levelMusic1,4,0,56]
level540 = [section4,'level345',6,0,54,"Sendero de juguetes",0,levelMusic2,4,0,57]
level550 = [section4,'level350',6,0,55,"Trinidad",0,levelMusic3,0,0,52]
level560 = [section4,'level355',6,0,56,"Virtud",0,levelMusic4,0,0,53]
level570 = [section4,'level360',6,0,57,"Embrujado",0,levelMusic1,0,0,54]
level580 = [section4,'level365',6,0,58,"Atracciones abandonadas",0,levelMusic3,0,0,49]
level590 = [section4,'level370',6,0,59,"Fantasmas y juguetes",0,levelMusic3,0,0,50]
level600 = [section4,'level375',6,0,60,"C4RR3R4",0,levelMusic4,0,0,51]

level610 = [section1A,'level710',6,0,61,"La salida",0,levelMusic1,1,0,16]
level620 = [section2A,'level720',6,0,62,"Salto largo",0,levelMusic1,0,0,32]
level630 = [section3A,'level730',6,0,63,"Entrada del parque",0,levelMusic1,0,0,48]
